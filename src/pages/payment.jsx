...
const PaymentManager = () => {
  ...
  useEffect(() => {
    fetchPayments();
  }, [fetchPayments, loggedInStudentId]);

  const handleAddPayment = async (e) => {
    e.preventDefault();
    try {
      const res = await fetch(
        apiUrl("/api/payment/add"),
        {
          method: "POST",
        ...
        <div className="row mb-4 align-items-center">
          <div className="col-md-7">
            <h2 className="fw-bold text-dark mb-1">
              <i className="bi bi-shield-check text-primary me-2"></i>Payment
              Ledger
            </h2>
          ...
          <div className="col-md-5 text-md-end">
            <div className="d-inline-flex gap-2 bg-white p-2 rounded-pill shadow-sm">
              <button
                className={`btn btn-sm px-4 rounded-pill border-0 ${
                  activeTab === "history" ? "btn-primary" : "text-muted"
                }`}
              ...
              <button
                className={`btn btn-sm px-4 rounded-pill border-0 ${
                  activeTab === "add" ? "btn-primary" : "text-muted"
                }`}
        ...
        <div className="row g-4">
                ...
                <form onSubmit={handleAddPayment} className="row g-3">
                  ...
                  <div className="col-md-6">
                    ...
                    <input
                      type="text"
                      className="form-control bg-light border-0"
                      placeholder="Bank/Office Receipt #"
                  ...
                  <div className="col-12">
                    ...
                    <textarea
                      className="form-control bg-light border-0"
                      rows="2"
                      placeholder="Ex: Admission Fee, Midterm Fee..."
                      value={formData.note}
                      onChange={(e) =>
          ...
          <div className="col-lg-4">
            <div className="card border-0 shadow-sm rounded-5 p-4 bg-primary text-white mb-4">
              <h6 className="text-uppercase small opacity-75 fw-bold tracking-wider">
                Total Amount Paid
              </h6>
            ...
            <div className="card border-0 shadow-sm rounded-5 p-4 bg-white">
              ...
              <div className="d-flex align-items-center mb-3">
                <div className="icon-circle bg-light text-primary me-3">
              ...
              <div className="d-flex align-items-center">
                <div className="icon-circle bg-light text-success me-3">
